...
set "OUTPUT=%WORKSPACE_DIR%\build\scan_smoke_test.exe"
set "SCAN_CU=%WORKSPACE_DIR%\kernels\scan.cu"
set "SCAN_SMOKE_TEST_CU=%WORKSPACE_DIR%\kernels\scan_smoke_test.cu"
...
"%NVCC%" -m64 -std=c++20 -arch=sm_89 -lineinfo -o "%OUTPUT%" "%SCAN_CU%" "%SCAN_SMOKE_TEST_CU%"
exit /b %errorlevel%