...
"%NVCC%" -m64 -std=c++20 -arch=sm_89 -lineinfo -DOPENTURBO_CAPI_EXPORTS -I"%WORKSPACE_DIR%\include" -o "%OUTPUT%" "%ENCODER_CU%" "%SCAN_CU%" "%C_API_CU%" "%GGML_ADAPTER_CPP%" "%SMOKE_TEST_CPP%"
exit /b %errorlevel%
