...
def parse_probe_output(output: str, returncode: int) -> tuple[str, str, str, str]:
    ...
    return probe_match.group(0), shadow_match.group(0), shadow_read_match.group(0), shadow_score_match.group(0)


def run_probe(runner: Path, model_path: Path, prompt: str, seed: str, ngl: str) -> tuple[str, str, str, str]:
    command = [str(runner)]
...
def main() -> int:
    ...
    probe_line, shadow_line, shadow_read_line, shadow_score_line = run_probe(runner, model_path, args.prompt, args.seed, args.ngl)
